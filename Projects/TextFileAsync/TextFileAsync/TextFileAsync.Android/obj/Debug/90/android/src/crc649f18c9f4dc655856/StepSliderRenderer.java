...
public class StepSliderRenderer
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.FormsBook.Platform.Android.StepSliderRenderer, XFBP.Android", StepSliderRenderer.class, __md_methods);
	}


	public StepSliderRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == StepSliderRenderer.class)
			mono.android.TypeManager.Activate ("Xamarin.FormsBook.Platform.Android.StepSliderRenderer, XFBP.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public StepSliderRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == StepSliderRenderer.class)
			mono.android.TypeManager.Activate ("Xamarin.FormsBook.Platform.Android.StepSliderRenderer, XFBP.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public StepSliderRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == StepSliderRenderer.class)
			mono.android.TypeManager.Activate ("Xamarin.FormsBook.Platform.Android.StepSliderRenderer, XFBP.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
